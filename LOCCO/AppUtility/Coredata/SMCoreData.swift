...
class SMCoreData: NSObject {
    static let shared = SMCoreData()
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "LOCCO")
...
//            container.viewContext.mergePolicy = NSErrorMergePolicy
            ...
            if let error = error as NSError? {
                 ...
                 */
                print("[CoreDataStorage] persistentContainer error: ", error)
...
//                fatalError("Unresolved error \(error), \(error.userInfo)")
    ...
    func insertInto(entity:String, parameter:[String:Any]) throws  {
    ...
    func fetch(entity:String, predicate:NSPredicate? = nil) throws -> [NSFetchRequestResult] {
    ...
    ///     - predicate: The predicate of the fetch request.
    ///     - parameter: All the attrbutes with its value
    func update(entity:String, predicate:NSPredicate, parameter:[String:Any]) throws -> [NSManagedObject]? {
    ...
    ///     - entity:  Name of entity in which you want to delete
    ///     - predicate: The predicate of the fetch request.
    func delete(entity:String, predicate:NSPredicate) throws {
        let manageContext = managedObjectContext()
    ...
    func delete(object:NSManagedObject) throws {
        ...
        try SMCoreData.shared.saveContext()
    }
}
